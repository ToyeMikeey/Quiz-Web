...
function calculateAndShowResult() {
    ...
    quizResult.style.marginBottom = '20px'
    quizResult.innerHTML =
        '<p>Dear ' + userName + ', with exam number ' + examNo + ', you scored ' + score + ' out of ' + questions.length + '</p>';
    var showDetailButton = document.createElement('button');
    showDetailButton.innerHTML = 'View Detailed Result';
    showDetailButton.style.height = '50px'
    showDetailButton.style.width = '100px'
    showDetailButton.onclick = function () {
        resultDetailsContainer.style.display = resultDetailsContainer.style.display === 'none' ? 'block' : 'none';
        resultDetailsContainer.style.gap = '20px'
    };

    var resultDetailsContainer = document.createElement('div');
    resultDetailsContainer.className = 'resultDetaill'
    resultDetailsContainer.innerHTML = resultDetails;
    resultDetailsContainer.style.display = 'none';

    quizResult.appendChild(showDetailButton);
